...
# install.packages(c("tidyverse", "tidytext", "dendextend", "cluster")) TODO update this line
...
Some of the criterias are shown below.
...
The Rand index (value between 0 and 1) describes how similar two clusterings are, 1 beeing the exact same.
